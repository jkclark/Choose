...
import type { ThankYouModalRef } from "./components/ThankYouModal";
import ThankYouModal from "./components/ThankYouModal";

const ChooseExperiment: React.FC = () => {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-start">
      ...
      <div
        className={`flex w-full flex-1 items-center justify-center transition-opacity duration-300 ease-in-out ${
...
export default ChooseExperiment;
